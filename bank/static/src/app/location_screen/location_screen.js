...
class ProductCombosScreen extends TicketScreen {
    ...
    setup() {
        ...
        this.productCombosButton = new ProductCombosButton(); // Instantiate ProductCombosButton
    }
...
//        this.ProductCombosButton.setView(loc.name); // Call setView on the instance of ProductCombosButton
    }
}
